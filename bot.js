...
client.on('guildMemberAdd', member => { //Event for when a user joins the server
    ...
    message.member.send('Welcome to the Kingdom! Please check out the "royal-meme-decree" channel for all of the server rules as well as the "noble-meme-decree" for every channel rules and regulations!')
});
